          ...
          <table class="table stacktable" id="tabla">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center"> <a href="desarrollo.php" type="button " class="btn btn-primary" name="A">Ver</a </td>
                    </tr>
                <tr>
                <td> Cuadro</td>
                <td class="text-center"> <a href="desarrollo.php" type="button " class="btn btn-primary" name="B">Ver</a </td>
                </tr>
                <tr>
                <td>Horario</td>
                <td class="text-center"> <a href="desarrollo.php" type="button " class="btn btn-primary" name="C">Ver</a </td>
                </tr>
                <tr>
                  <td>Diario Pedagogo</td>
                  <td class="text-center"> <a href="desarrollo.php" type="button " class="btn btn-primary" name="D">Ver</a </td>
                      </tr>
                  <tr>
                  <td>Informe Mensual de Educacion</td>
                  <td class="text-center"> <a href="desarrollo.php" type="button " class="btn btn-primary" name="E">Ver</a </td>
                  </tr>
                  <tr>
                  <td>Hoja de Asistencia</td>
                  <td class="text-center"> <a href="desarrollo.php" type="button " class="btn btn-primary" name="F">Ver</a </td>
                  </tr>
